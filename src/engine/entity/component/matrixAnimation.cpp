...
MatrixAnimation::MatrixAnimation(SpatialPawn* s, const MatrixAnimation::AnimationType type) : GameComponent(s) {
	animation_speed = 1;
	old_percentage = 0;
	percentage = 0;
	this->type = type;
...
void MatrixAnimation::setAnimation(const MatrixAnimation::AnimationType newType) {
	type = newType;
}
